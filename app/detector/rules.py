...
RULE_KEY_ALIASES = {
    ...
    "buy_2m_bid_trade_value": "buy_1m_bid_trade_value",
...
STRATEGY_DEFINITIONS = {
    "spike": {
        "strategy_key": "spike",
        "name": "급등 감지",
        "description": "최근 매수 거래대금, 절대 TPS, 가격 변동을 기준으로 급등 후보를 감지합니다.",
        "rules": [
            {
                "rule_key": "buy_1m_bid_trade_value",
                "label": "최근 1분 매수 거래대금",
                "description": "최근 1분 동안 누적된 매수 거래대금 하한선입니다.",
                "metric_key": "buy_1m_bid_trade_value",
                "operator_default": ">=",
                "sort_order": 10,
            },
            {
                "rule_key": "tps_now",
                "label": "최근 1분 평균 TPS 최소치",
                "description": "최근 1분 동안 발생한 전체 체결 건수를 60초로 나눈 평균 TPS 하한입니다.",
                "metric_key": "tps_now",
                "operator_default": ">=",
                "sort_order": 20,
            },
            {
                "rule_key": "tps_now_max",
                "label": "최근 1분 평균 TPS 최대치",
                "description": "최근 1분 동안 발생한 전체 체결 건수를 60초로 나눈 평균 TPS 상한입니다.",
                "metric_key": "tps_now",
                "operator_default": "<=",
                "sort_order": 30,
            },
            {
                "rule_key": "price_change_pct_min",
                "label": "최소 가격 변동률",
                "description": "최근 1분 동안 최소한 이 정도 가격 움직임이 있는 종목만 봅니다.",
            ...
            },
            {
                ...
                "label": "최대 가격 변동률",
                "description": "최근 1분 동안 가격이 과하게 튄 종목은 제외합니다.",
                "metric_key": "price_change_pct",
                "operator_default": "<=",
                "sort_order": 50,
            },
    ...
    if strategy_key == "spike":
        ...
        return {
            ...
            "rules": [
                {
                    "rule_key": "buy_1m_bid_trade_value",
                    "label": get_rule_definition_map("spike")["buy_1m_bid_trade_value"]["label"],
                    "enabled": True,
                    "operator": get_rule_definition_map("spike")["buy_1m_bid_trade_value"]["operator_default"],
                    "threshold_value": config.buy_1m_bid_trade_value_min,
                    "params_json": "{}",
                    "sort_order": get_rule_definition_map("spike")["buy_1m_bid_trade_value"]["sort_order"],
                },
                {
                    "rule_key": "tps_now",
                    "label": get_rule_definition_map("spike")["tps_now"]["label"],
                    "enabled": True,
                    "operator": get_rule_definition_map("spike")["tps_now"]["operator_default"],
                    "threshold_value": config.tps_min,
                    "params_json": "{}",
                    "sort_order": get_rule_definition_map("spike")["tps_now"]["sort_order"],
                },
                {
                    "rule_key": "tps_now_max",
                    "label": get_rule_definition_map("spike")["tps_now_max"]["label"],
                    "enabled": True,
                    "operator": get_rule_definition_map("spike")["tps_now_max"]["operator_default"],
                    "threshold_value": config.tps_max,
                    "params_json": "{}",
                    "sort_order": get_rule_definition_map("spike")["tps_now_max"]["sort_order"],
                },
                {
                    "rule_key": "price_change_pct_min",
                    "label": get_rule_definition_map("spike")["price_change_pct_min"]["label"],
                    "enabled": True,
                    "operator": get_rule_definition_map("spike")["price_change_pct_min"]["operator_default"],
                    "threshold_value": config.price_change_pct_min,
                    "params_json": "{}",
                    "sort_order": get_rule_definition_map("spike")["price_change_pct_min"]["sort_order"],
                },
                {
                    "rule_key": "price_change_pct",
